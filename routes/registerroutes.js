...
// The code below works properly-- by saving to the database and updates the form list
...
router.get("/search", async (req, res)=>{
   ...
   // catch(err){
   //     res.status(500).send("unable to search in the databas")
   // }
})
